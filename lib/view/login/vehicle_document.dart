...
import 'package:my_texi/view/login/subscription_plan.dart';
...
class VehicleDocument extends StatefulWidget {
  ...
  @override
  State<VehicleDocument> createState() => _DocumentViewState();
}

class _DocumentViewState extends State<VehicleDocument> {
  List documentList = [
    {
      "Name":"RC Book",
          ...
          child: Column(
            ...
            children: [
              ...
              RoundButton(title: "NEXT", onPress: () {
                context.push(const SubscriptionPlan());
              }),
            ],
          ),
        ),
